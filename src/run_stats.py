...
def analyze_graph_and_alignments(threads="8", tree_pars=10, tree_bs=10, input_dir="/data/pggb_output",
                                 ...
                                 window_size=1000, phyl_tree=True, plots=True, only_stats=False,tree_type='graph',softcore_threshold=90):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=90,
        help="Percentage threshold for soft-core node classification (default: 90)"
    )
