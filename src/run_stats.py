...
from utils import (
    ...
    render_phylotree, write_odgi_matrix, convert_gfa
)
...
def analyze_graph_and_alignments(threads="8", tree_pars=10, tree_bs=10, input_dir="/data/pggb_output",
                                 ...
                                 window_size=1000, phyl_tree=True, plots=True, only_stats=False,tree_type='graph',softcore_threshold=5):
    ...
    if plots:
        ...
        plot_node_histogram_by_paths(count_dist, num_paths, os.path.join(graph_dir, "node_histogram_by_paths.png"), int(softcore_threshold))

    # Step 6: Write Consensus path sequence to file
    cons_path, cons_seq, cycle_stat = extract_consensus_path(nodes, edges, node_count_hist,
                                                 edges_count,paths,
