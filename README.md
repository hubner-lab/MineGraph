...
<p align="center">
  ...
  <a href="https://doi.org/10.21203/rs.3.rs-8786947/v1"><img src="https://img.shields.io/badge/Preprint-ResearchSquare-b5000a?logo=researchgate" alt="Preprint"></a>
  <a href="https://doi.org/10.21203/rs.3.rs-8786947/v1"><img src="https://img.shields.io/badge/DOI-10.21203%2Frs.3.rs--8786947%2Fv1-blue" alt="DOI"></a>
...
If you use MineGraph in your research, please cite:

> **Haib R., Hübner S. et al.** Evolutionary graph pangenome of the order Poales from chloroplast genomes highlights phylogenetic inconsistencies. *Research Square* (preprint, 2024).  
> https://doi.org/10.21203/rs.3.rs-8786947/v1  
...
```bibtex
@article{haib2024minegraph,
  author    = {Haib, Rakan and H{\"u}bner, Sariel and others},
  title     = {Evolutionary graph pangenome of the order {Poales} from
               chloroplast genomes highlights phylogenetic inconsistencies},
  journal   = {Research Square},
  year      = {2024},
  note      = {Preprint},
  doi       = {10.21203/rs.3.rs-8786947/v1},
  url       = {https://doi.org/10.21203/rs.3.rs-8786947/v1}
}
```
...
If you use MineGraph, please also cite the tools it depends on:
